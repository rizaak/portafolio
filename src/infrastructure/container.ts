...
import { JsonEnterpriseClientRepository } from "./repositories/json-enterprise-client-repository";
...
export function createJsonBackedContainer(): PortfolioContainer {
  return {
    ...
    enterpriseClientRepository: new JsonEnterpriseClientRepository(),
  };
}
